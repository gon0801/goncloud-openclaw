...
# Uso: corrida.sh <abrir|lanzar-sesion|terminar-sesion|reconciliar-marcas|cerrar|preflight|estado|latido|responder|seguimiento|migrar-seguimiento|adaptador|preparar-carril|mostrar-terminal|reconciliar|compuerta> ...
set -u
