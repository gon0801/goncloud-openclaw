...
| 10 | Cierre en vivo | Datos de la tabla de máquinas de 6.3 en `goncloud-workspace-main/AGENTS.md`; si esa tabla aun no está mergeada, el dato se toma del texto de la fila del PR A, o se escribe `unknown`. | Mensaje "Live <SHA> en <URL>" a David con el SHA mergeado y la URL viva de la tabla (o unknown). |
