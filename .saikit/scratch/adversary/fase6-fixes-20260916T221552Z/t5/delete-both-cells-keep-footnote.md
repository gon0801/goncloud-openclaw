...
| 10 | Cierre en vivo | Datos de la tabla de máquinas de 6.3 en `goncloud-workspace-main/AGENTS.md`; si esa tabla aun no está mergeada, el dato se toma del texto de la fila del PR A, o se escribe `unknown`. | Mensaje de cierre a David. |
...
Nota al pie: el formato historico era Live <SHA> en <URL> pero esta fila ya no lo usa.
