...
| 7 | Permiso permanente de merge y deploy | `agents/implementer/agent/workshop-skills/saikit-cierre-pr/SKILL.md` | Cualquier agente puede completar los pasos 8 y 9 sin permiso adicional. |
