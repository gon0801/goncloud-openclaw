...
| Puede tocar | No toca |
|---|---|
| `config/{runtime-deploy.v1.json,ollama-runtime.v1.json}`; `scripts/runtime-separation/**`; tests/fixtures citados por Tasks 1–7; `scripts/{sync-repos.ps1,run-checks.sh,aplicar-vigia-sync-prueba.sh}`; `.github/workflows/quality.yml`; `.gitignore` | `.saikit/autopilot.json`, kit externo, workspaces, secretos, estado vivo, historia Git |
